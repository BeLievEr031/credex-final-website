...
function SingleBlog6() {
    return (
        <main className="font-pp-mori-regular">
            ...
            <main className="flex gap-2 justify-center  pt-18">
                ...
                <section className=" w-[411px] relative">
                    <div className="flex justify-center items-center sticky top-[100px]">
                        <div className="bg-[#062f2a] text-white  rounded-sm shadow-lg relative py-15 px-10 w-full">
                            ...
                            <div className="flex justify-center">
                                <button className="bg-[#0FF395] text-black font-medium px-6 py-3 rounded-lg transition">

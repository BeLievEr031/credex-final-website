        ...
        <main className="pt-40 md:pt-48 font-pp-mori-regular">
            ...
            <section className="px-3 md:px-24">
                <div className="grid md:grid-cols-2">
                    ...
                    <div className="hidden md:block py-12 md:py-3 bg-[#1212120A] md:px-4 rounded-xl space-y-2 cursor-pointer" onClick={() => navigate(`${"how-we-bootstrapped-a-fintech-startup-to-$2m-arr-using-smart-ai-infrastructure:-a-founder’s-case-study"}`)}>

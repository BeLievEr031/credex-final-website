        ...
        <main className="pt-40 md:pt-48 font-pp-mori-regular">
            ...
            <section className="px-3 md:px-24">
                <div className="grid md:grid-cols-2">
                    ...
                    <div className="hidden md:block py-12 md:py-3 bg-[#1212120A] md:px-4 rounded-xl space-y-2 cursor-pointer" onClick={() => navigate(`${"your-unused-openai-credits-are-expiring-heres-how-to-sell-them-before-they-hit-zero"}`)}>
                        ...
                        <div className="w-full md:w-[520px] h-[230px] md:h-[281px] bg-[#1C1C1C] rounded-xl mt-6 overflow-hidden">
                            <img
                                src="https://miro.medium.com/v2/resize:fit:788/1*Qz8Bq2M15SqAQ_7xFFQA6w.png"
...
const BlogCard11 = () => {
    ...
    return <div
        className="cursor-pointer w-full max-w-[378px]"
        onClick={() =>
            navigate("how-to-build-ai-powered-products-without-burning-developer-budget")
        }
    >
        <div className="bg-[#121212] w-full h-[200px] sm:h-[220px] md:h-[230px] rounded-[20px] overflow-hidden">
            <img
                src="https://miro.medium.com/v2/resize:fit:788/1*ZrAsb8CoeQAyTVkYueMmyg.png"
                alt=""
                className="w-full h-full object-cover object-top"
            />
        </div>
...
const BlogCard13 = () => {
    ...
    return <div
        className="cursor-pointer w-full max-w-[378px]"
        onClick={() =>
            navigate("how-to-get-cloudflare-enterprise-credits-at-50-off-250k-in-cdn-security-edge-compute")
        }
    >
        <div className="bg-[#121212] w-full h-[200px] sm:h-[220px] md:h-[230px] rounded-[20px] overflow-hidden">
            <img
                src="https://miro.medium.com/v2/resize:fit:788/1*exOF2q05fbmIU3hwiqidrg.png"
                alt=""
                className="w-full h-full object-cover object-top"
            />
        </div>
        ...
        <p className="text-lg sm:text-xl md:text-2xl font-semibold pt-4 w-full">
            How to Get Cloudflare Enterprise Credits at 50% Off: $250K in CDN, Security & Edge Compute for $125K
        </p>

        <div className="flex items-center gap-2 text-sm text-[#19363FB2] pt-2">
            <p>Credex • 04th June, 2026</p>
        </div>
    </div>
}
...
const BlogCard14 = () => {
    ...
    return <div
        className="cursor-pointer w-full max-w-[378px]"
        onClick={() =>
            navigate("stop-paying-full-price-for-gpt-5-5-how-to-get-500k-in-openai-tier-5-credits-at-50-off")
        }
    >
        <div className="bg-[#121212] w-full h-[200px] sm:h-[220px] md:h-[230px] rounded-[20px] overflow-hidden">
            <img
                src="https://miro.medium.com/v2/resize:fit:828/format:webp/1*FmNN699qytyI0oUYUYMqSg.png"
                alt=""
                className="w-full h-full object-cover object-top"
            />
        </div>
        ...
        <p className="text-lg sm:text-xl md:text-2xl font-semibold pt-4 w-full">
            Stop Paying Full Price for GPT-5.5: How to Get $500K in OpenAI Tier 5 Credits at 50% Off
        </p>

        <div className="flex items-center gap-2 text-sm text-[#19363FB2] pt-2">
            <p>Credex • 28th June, 2026</p>
        </div>
    </div>
}
...
const BlogCard15 = () => {
    ...
    return <div
        className="cursor-pointer w-full max-w-[378px]"
        onClick={() =>
            navigate("your-unused-openai-credits-are-expiring-heres-how-to-sell-them-before-they-hit-zero")
        }
    >
        <div className="bg-[#121212] w-full h-[200px] sm:h-[220px] md:h-[230px] rounded-[20px] overflow-hidden">
            <img
